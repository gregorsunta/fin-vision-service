 ...
 */
const receiptExtractionSchema: FunctionDeclaration = {
  name: 'extract_receipt_data',
  description:
    'Extracts structured data from a receipt image or text. Captures store details, line items, and totals.',
  parameters: {
...
export class PromptManager {
   ...
   */
  getExtractionTool(extraFields: string[] = []): Tool {
   ...
   */
  createExtractionPrompt(ocrText: string): string {
    return `
